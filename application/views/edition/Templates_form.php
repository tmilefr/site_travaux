	...
	<div class="card-body">
		<div class="form-row">
			<div class="form-group col-md-4">
				<?php 
					echo $this->render_object->label('id_type');
					echo $this->render_object->RenderFormElement('id_type'); 
				?>
			</div>
		...
		<div class="form-group col-md-12">
				<?php 
					echo $this->render_object->label('text');
					echo $this->render_object->RenderFormElement('text'); 
				?>
			</div>	
		</div>
