		...
		<div class="card-body">
			<div class="form-row">
				<div class="form-group col-md-12">
					<?php 
						echo $this->render_object->label('reference');
						echo $this->render_object->RenderFormElement('reference');
					?>
				</div>	
			</div>
			<div class="form-row">
				...
				<div class="form-group col-md-4">
					<?php 
						echo $this->render_object->label('object');
			...
			<div class="form-row">	
				<div class="form-group col-md-12">										
					<?php 
						echo $this->render_object->label('message');
						echo $this->render_object->RenderFormElement('message');
					?>
				</div>
			</div>
			<div class="form-row">								
				<div class="form-group col-md-12">
					<?php 
						...
						echo $this->render_object->RenderFormElement('detail_statut'); 
					?>
				</div>	
			</div>
		</div>
