		...
		<div class="card-body">
			<div class="form-row">
				<div class="form-group col-md-4">
					<?php 
						echo $this->render_object->label('id_fam');
						echo $this->render_object->RenderFormElement('id_fam');
					?>
				</div>
				<div class="form-group col-md-4">
					<?php 
			...
			<div class="form-row">	
				<div class="form-group col-md-4">
					<?php 
						...
						echo $this->render_object->RenderFormElement('phone'); 
					?>
				</div>	
				<div class="form-group col-md-4">														
					<?php 
			...
			<div class="form-row">	
				<div class="form-group col-md-4">
					<?php 
						echo $this->render_object->label('thumbnail');
						echo $this->render_object->RenderFormElement('thumbnail'); 
					?>
				</div>	
				<div class="form-group col-md-4">
					<?php 
						echo $this->render_object->label('picture');
						echo $this->render_object->RenderFormElement('picture');
					?>
				</div>
			</div>						
