...
class GroupesMembers_controller extends MY_Controller {
	...
	public function __construct(){
		...
		$this->_controller_name = 'GroupesMembers_controller';  //controller name for routing
		$this->_model_name 		= 'GroupesMembers_model';	   //DataModel
		$this->_edit_view 		= 'edition/GroupesMembers_form';//template for editing
		$this->_list_view		= 'unique/GroupesMembers_view.php';
